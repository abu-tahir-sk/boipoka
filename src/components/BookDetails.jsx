...
import { addStoredDB, addWishListDB } from "../Utility/AddToDB";
  ...
  return (
    <div className=" flex justify-center gap-12  overflow-hidden bg-white mt-14">
      <div className="w-1/2 p-16 bg-[#131313]/5 rounded-lg ">
        <img
          className="w-[425px] h-[564px] mx-auto  transition-all duration-300 hover:shadow-xl hover:-translate-y-1   skew-3"
          src={image}
          alt=""
        />
      </div>
      <div className="w-1/2">
        ...
        <div className="flex gap-8 mt-8">
          <button
            className="border border-gray-600/25 py-2 px-3 rounded-lg font-bold"
            onClick={() => handleRead(id)}
          >
            Read
          </button>{" "}
          <button
            className="text-white bg-[#50B1C9] font-bold py-2 px-4 rounded-lg"
